...
class _AAState extends State<AA> {
  final String url="http://api.openweathermap.org/data/2.5/weather?q=Thiruvananthapuram&APPID=e72b0b3dbe7a501c93aa8c1859cf1ace";
  var userData;
  bool isloading = true;
  var temp;
  var hum;
   ...
   Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Thiruvananthapuram Weather Report"),
      ),
      body: Container(
        child: Center(
          child: isloading
